var u={searchable:!1,dropdownHeightPx:400,height:"32px",width:"100%"};function F(){return`
    ...
    `}function q(n){let e=Y(n),t=["worse-select-container"];m(n)&&t.push("listbox"),w(n)&&t.push("multiple");let o=`
    <div class="${t.join(" ")}">
      <button
        type="button"
