"use strict";var D=Object.defineProperty;var j=Object.getOwnPropertyDescriptor;var Y=Object.getOwnPropertyNames;var J=Object.prototype.hasOwnProperty;var Z=(n,e)=>{for(var t in e)D(n,t,{get:e[t],enumerable:!0})},Q=(n,e,t,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Y(e))!J.call(n,s)&&s!==t&&D(n,s,{get:()=>e[s],enumerable:!(o=j(e,s))||o.enumerable});return n};var X=n=>Q(D({},"__esModule",{value:!0}),n);var pe={};Z(pe,{worseSelect:()=>V});module.exports=X(pe);var u={searchable:!1,dropdownHeightPx:400,height:"32px",width:"100%"};function K(){return`
    ...
    `}function U(n){let e=ne(n),t=["worse-select-container"];m(n)&&t.push("listbox"),w(n)&&t.push("multiple");let o=`
    <div class="${t.join(" ")}">
      <button
        type="button"
