var p={searchable:!1,dropdownHeightPx:400,height:"32px",width:"100%"};function K(){return`
    :root {
    ...
    `}function R(n){let e=Y(n),t=["worse-select-container"];h(n)&&t.push("listbox"),w(n)&&t.push("multiple");let o=`
    <div class="${t.join(" ")}">
      <button
        type="button"
